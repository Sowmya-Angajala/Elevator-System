...
var CloseDoorStateImpl_1 = require("./elevatorStates/CloseDoorStateImpl");
var Elevator = /** @class */ (function () {
    ...
    Elevator.prototype.enqueueFloor = function (floor) {
        if (!this.requestQueue.includes(floor)) {
            this.requestQueue.push(floor);
            this.processQueue();
        }
    };
    Elevator.prototype.processQueue = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(this.requestQueue.length > 0)) return [3 /*break*/, 4];
    ...
    Elevator.prototype.updateDisplay = function () {
        console.log("Current floor is ".concat(this.currentFloor, ", Direction: ").concat(this.direction));
    };
    return Elevator;
}());
